            ...
            >
              <header className="flex items-start justify-between gap-3">
                ...
                <div className="flex items-baseline">
                  <span
                    className="scene-mono text-2xl font-semibold leading-none tabular-nums text-[var(--scene-gold)]"
                    style={{ textShadow: "0 0 12px rgba(255, 184, 0, 0.2)" }}
                  >
                    {String(result.score).padStart(2, "0")}
                  </span>
                  <span className="ml-0.5 text-base tabular-nums text-white/55">
                    /10
                  </span>
                </div>
              </header>

              <p className="mt-4 italic text-sm leading-snug text-white/85">
